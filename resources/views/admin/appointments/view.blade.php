...
@section('content')
  <div class="layout-wrapper layout-content-navbar">
    ...
    @endif
      ...
      @csrf
      <button type="submit" class="btn btn-sm btn-success" title="Confirm the appointments"><i
      class="fa-solid fa-square-check"></i></button>
      </form>

      <!-- Cancel Button Form -->
      <form
      action="{{ route('admin.appointments.updateStatus', ['id' => $appointment->id, 'status' => 'cancelled']) }}"
      method="POST" style="display:inline;">
      @csrf
      <button type="submit" class="btn btn-sm btn-warning" title="Cancel the appointments"><i
