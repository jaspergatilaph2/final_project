    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <!-- Layouts -->
                <li class="menu-item {{$ActiveViewMenu === 'View' ? 'active' : ''}}">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item {{ $ActiveViewSubMenu === 'Events' ? 'active' : '' }}">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($event->date)->setTimezone(config('app.timezone'))->format('Y-m-d') }}</td>
                                            <td>{{ \Carbon\Carbon::parse($event->time)->setTimezone(config('app.timezone'))->format('h:i A') }}</td>
                                            <td>{{ \Carbon\Carbon::parse($event->endtime)->setTimezone(config('app.timezone'))->format('h:i A') }}</td>
                                        </tr>
                                        @endforeach
