  ...
  <div class="layout-container">
    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
      ...
      <ul class="menu-inner py-1">
        ...
        <!-- Layouts -->
        <li class="menu-item {{ $ActiveCreateMenu === 'Create' ? 'active' : '' }}">
          ...
          <ul class="menu-sub">
            <li class="menu-item {{ $ActiveCreateSubMenu === 'Event' ? 'active' : '' }}">
                ...
                <div class="card-body">
                  <form method="POST" action="{{ route('admin.events.store') }}">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="events-name" name="eventsName" placeholder="Name of event..." required />
                    </div>

                    <div class="mb-3">
                      <label class="form-label" for="events-description">Description of Event</label>
                      <input type="text" class="form-control" id="events-description" name="description" placeholder="Description..." required />
                    </div>
                    ...
                    <div class="mb-3">
                      ...
                      <textarea class="form-control" id="event-textarea" name="eventsText" placeholder="Write your event here..." rows="4" required></textarea>
                    </div>
