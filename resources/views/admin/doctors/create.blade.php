    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
      ...
      <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{$activeMenu === 'Doctors' ? 'active' : '' }}">
          ...
          <ul class="menu-sub">
            <li class="menu-item {{ $activeSub === 'Add Doctors' ? 'active' : '' }}">
              <a href="layouts-without-menu.html" class="menu-link">
    ...
    <div class="layout-page">
      ...
      <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Add/</span> Doctors</h4>
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method="POST" action="{{ route('admin.doctors.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      <label class="form-label" for="basic-default-company">Hospital Name</label>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" id="basic-default-phone" class="form-control" name="phone"
                        placeholder="658 799 8941" required />
                    </div>
                    <div class="mb-3">
                      <label class="form-label" for="basic-default-phone">Specialization</label>
                      <input type="text" id="basic-default-phone" class="form-control" name="specialization"
                        placeholder="Specialization" required />
                    </div>
                    <div class="mb-3">
                      <label class="form-label" for="basic-default-image">Upload Image</label>
                      <input type="file" id="basic-default-image" class="form-control" name="image" accept="image/*"
                        required />
                    </div>
                    <div class="mb-3">
