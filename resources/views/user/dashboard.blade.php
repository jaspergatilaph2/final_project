...
@endif 
    fa-envelope">
              ...
              <ul class="dropdown-menu dropdown-menu-end shadow-lg p-2" aria-labelledby="notificationDropdown"
                style="min-width: 300px; max-width: 90vw; text-decoration: none;">
                @if(auth()->check())
                ...
                <li class="dropdown-item d-flex align-items-start">
                  <div class="flex-grow-1">
                    <a href="{{ route('user.events.view', ['notificationId' => $notification->id]) }}"
                      ...
                      <p class="mb-1 text-muted notification-text"
                        style="max-height: 100px; overflow-y: auto; word-wrap: break-word; white-space: normal;">
                        {{ $notification->data['received_message'] }}
                      </p>
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0 me-3">
                      <div class="avatar avatar-online">
                        <img
                          src="{{ auth()->user()->avatar ? asset('storage/' . auth()->user()->avatar) : asset('sneat/img/avatars/1.png') }}"
                          alt class="w-px-auto h-px-auto rounded-circle" />
                      </div>
                    </div>
                    <div class="flex-grow-1">
              ...
              <div class="col-md-4 pt-3">
                <div class="card" style="height:400px;">
                  <div class="card-body">
                    ...
                    <p class="card-text">Here the <span class="fw-bold" style="color: #ff6347;">total</span> events.</p>
                    <div style="display: flex; justify-content: center; align-items: center; height:13rem;">
                      <strong style="font-size:8.5rem; text-align:center;">{{\App\Models\events::count()}}</strong>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 pt-3">
                <div class="card" style="height:400px;">
                  <div class="card-body">
                    ...
                    <div style="display: flex; justify-content: center; align-items: center; height:13rem;">
                      @auth
                      @if(auth()->user()->name) <!-- Check column name -->
              ...
              <div class="col-md-4 pt-3">
                <div class="card" style="height: 400px;">
                  <div class="card-body">
                    ...
                    ['status', '=', 'confirmed'],
                    ['user_id', '=', auth()->id()],
                    ])->get(['id', 'status', 'doctor_id', 'updated_at']) as $appointment)
                    @php
                    ...
                    <div class="appointment-item" data-appointment-id="{{ $appointment->id }}"
                      data-clear-time="{{ $clearingTime->timestamp }}" @if($remainingTime <=0) style="display:none;" @endif>
