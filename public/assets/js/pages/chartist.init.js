            ...
            seq++,
                "line" === e.type
                    ...
                    : "grid" === e.type &&
                      ...
                      ((n = {})[e.axis.units.pos + "1"] = t),
                      (n[e.axis.units.pos + "2"] = a),
                      (n.opacity = {
                          begin: seq * delays,
                          dur: durations,
                          from: 0,
...
(chart = new Chartist.Pie(
    ...
    var t, a;
    "slice" === e.type &&
        ((t = e.element._node.getTotalLength()),
        ...
        0 !== e.index &&
            (a["stroke-dashoffset"].begin = "anim" + (e.index - 1) + ".end"),
