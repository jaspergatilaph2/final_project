...
document.addEventListener("DOMContentLoaded", function () {
    var d = new bootstrap.Modal(document.getElementById("event-modal"), {
            keyboard: !1,
        }),
        t =
        ...
        c = [
            { title: "All Day Event", start: new Date(e, i, 1) },
            {
                title: "Long Event",
                start: new Date(e, i, l - 5),
                end: new Date(e, i, l - 2),
                className: "bg-warning",
            },
            {
                id: 999,
                title: "Repeating Event",
                start: new Date(e, i, l - 3, 16, 0),
                allDay: !1,
                className: "bg-info",
            },
            {
                id: 999,
                title: "Repeating Event",
                start: new Date(e, i, l + 4, 16, 0),
                allDay: !1,
                className: "bg-primary",
            },
            {
                title: "Meeting",
                start: new Date(e, i, l, 10, 30),
                allDay: !1,
                className: "bg-success",
            },
            {
                title: "Lunch",
                start: new Date(e, i, l, 12, 0),
                end: new Date(e, i, l, 14, 0),
                allDay: !1,
                className: "bg-danger",
            },
            {
                title: "Birthday Party",
                start: new Date(e, i, l + 1, 19, 0),
                end: new Date(e, i, l + 1, 22, 30),
                allDay: !1,
                className: "bg-success",
            },
            {
                title: "Click for Google",
                start: new Date(e, i, 28),
                end: new Date(e, i, 29),
                url: "http://google.com/",
                className: "bg-dark",
            },
    ...
    var v = new FullCalendar.Calendar(l, {
        timeZone: "local",
        editable: !0,
        droppable: !0,
        selectable: !0,
        ...
        eventResize: function (t) {
            ...
            c[e] &&
                ((c[e].title = t.event.title),
                (c[e].className = t.event.classNames[0]));
        },
        eventClick: function (e) {
            document.getElementById("edit-event-btn").removeAttribute("hidden"),
                ...
                (a = e.event),
                (document.getElementById("modal-title").innerHTML = ""),
                (document.getElementById("event-title").value = a.title),
                (document.getElementById("event-category").value = a.className),
                console.log("selectedEvent", a),
                document
    ...
    setTimeout(() => {
        ...
        n.addEventListener("submit", function (e) {
            ...
            var t,
                ...
                n = document.getElementById("event-category").value;
            a
                ? ((t = document.getElementById("eventid").value),
                  a.setProp("id", t),
                  a.setProp("title", e),
                  a.setProp("classNames", [n]),
                  (t = c.findIndex(function (e) {
                      return e.id == a.id;
                  })),
                  c[t] && ((c[t].title = e), (c[t].className = n)),
                  v.render())
                : ((t = {
                      id: (1e4 * Math.random()).toFixed(0),
                      title: e,
                      start: new Date(
                          document.querySelector("#calender").value
                      ),
                      allDay: !0,
                      className: n,
                  }),
            ...
            .addEventListener("click", function (e) {
                if (a) {
                    for (var t = 0; t < c.length; t++)
                        c[t].id == a.id && (c.splice(t, 1), t--);
                    a.remove(), (a = null), d.hide();
                }
            }),
        document
            .getElementById("btn-new-event")
            .addEventListener("click", function (e) {
                s(), document.getElementById("edit-event-btn").click();
            });
});
